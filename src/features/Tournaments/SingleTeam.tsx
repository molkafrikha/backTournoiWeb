...
const SingleTeam = (props: Props) => {
    ...
    return (
        <div draggable className="bg-neutral-500  font-normal shadow-2xl w-4/5 md:w-1/3 my-3 p-3 flex flex-col" >
            ...
            <img draggable={false} src={`${axios.defaults.baseURL}/uploads/${props.image_path}`} className="py-2 px-2 max-h-56 object-contain"></img>
